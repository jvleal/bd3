package com.meusgastosta.meusgastosta.controller;
...
import com.meusgastosta.meusgastosta.domain.service.TituloService;
...
public class TituloController {
    ...
    @PostMapping
    public ResponseEntity<TituloResponseDTO> cadastrar(@RequestBody 
    TituloRequestDTO dto){
        TituloResponseDTO responseDTO = tituloService.cadastrar(dto);
        return new ResponseEntity<>(responseDTO, HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<TituloResponseDTO> atualizar(@PathVariable Long id,
